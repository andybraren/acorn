        ...
        <form id="signup" action="<?php echo $page->url() . '/signup' ?>" method="post">
            ...
            <div role="group">
              ...
              <div class="size-50">
                ...
                <div class="icons"><?php echo (new Asset('/acorn/assets/images/form-user.svg'))->content() ?></div>
              </div>
              ...
              <div class="size-50">
                ...
                <div class="icons"><?php echo (new Asset('/acorn/assets/images/form-email.svg'))->content() ?></div>
